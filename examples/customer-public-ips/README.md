...
Description: Body-relative dot paths for this caller's supporting resources. Changes take effect after apply; ignored configuration is not sent to Azure. Leave empty so drift remains visible.

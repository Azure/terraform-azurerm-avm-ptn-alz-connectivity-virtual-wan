locals {
  firewall_default_ip_configuration = {
    for key, value in var.virtual_hubs : key => merge(value.firewall.default_ip_configuration, {
  ...
  firewall_ip_configurations = {
    for key, value in var.virtual_hubs : key => merge(value.firewall.ip_configurations, {
  ...
  firewall_management_ip_configuration = {
    for key, value in var.virtual_hubs : key => merge(value.firewall.management_ip_configuration, {
  ...
  firewall_policies = { for key, value in var.virtual_hubs : key => local.firewall_enabled[key] ? merge(value.firewall_policy, {
  ...
  firewalls = { for key, value in var.virtual_hubs : key => local.firewall_enabled[key] ? merge(value.firewall, {
